...
export POSTGRES_HOSTNAME=${POSTGRES_HOSTNAME:-db}
export POSTGRES_PORT=${POSTGRES_PORT:-5432}
export POSTGRES_USER=${POSTGRES_USER:-misp}
export POSTGRES_PASSWORD=${POSTGRES_PASSWORD:-example}
export POSTGRES_DB=${POSTGRES_DB:-misp}
export PGPASSWORD=${POSTGRES_PASSWORD:-example}
export POSTGRES_CMD="psql -U $POSTGRES_USER -h $POSTGRES_HOSTNAME -p $POSTGRES_PORT -d $POSTGRES_DB -t -A"
